...
(function($) {
	...
	//Cookies.set('test_cookie', guid,{ expires: Infinity , domain: 'beardgang.xyz'});
    ...
    */
    ...
    function loadTableData(page, page_size,sort,order) {
		...
		console.log("https://beardgang.xyz/api/api.php/products?order="+sort+order+"&page=" + page + "," + page_size);
        $.get("https://beardgang.xyz/api/api.php/products?order="+sort+order+"&page=" + page + "," + page_size)
	...
	$('#search-btn').click(function(event){
        ...
        $.get("https://beardgang.xyz/api/api.php/products?filter=desc,cs,"+searchtxt)
	...
	function addCartItem(item){
		...
		$.post("https://beardgang.xyz/api/api.php/shopping_cart/",postData);
	}
